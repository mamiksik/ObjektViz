from objektviz.frontend import ReplayMetadata, Token, ReplaySegment, TokenReplayPreferences
...
def generate_token_animation_segments(data: list[dict], start_date, end_date, animation_preferences: TokenReplayPreferences) -> tuple[list[str], list[Token], ReplayMetadata]:
