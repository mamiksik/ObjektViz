...
class OcelImport:
    ...
    def _import_nodes(self, csv, node_label):
        ...
        # define table for nodes
        define_table_query = ql.q_define_table(node_label, header)
        self._run_query(define_table_query)
    ...
    def import_e2o_relation(self):
        ...
        corr_ddl = ql.q_define_rel("CORR", "Event", "Entity", ["type"])
        self._run_query(corr_ddl)
